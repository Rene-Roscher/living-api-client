...
class Living
{
     ...
     */
    public function __construct($ddosApiToken, $installerApiToken, $trafficApiToken, $installerResellerId, $macAddressPrefix)
    {
        $this->ddosApiToken = $ddosApiToken;
        $this->installerApiToken = $installerApiToken;
        $this->installerResellerId = $installerResellerId;
		$this->trafficApiToken = $trafficApiToken;
        $this->uriDdosApi = 'https://ddos.living-bots.net/api/alerts?api_token='.$ddosApiToken;
		$this->uriTrafficApi = 'https://ipmgmt.living-bots.net/api/v1';
     ...
     * @return string
     */
    public function getUriTrafficApi(): string
    {
        return $this->uriTrafficApi;
    }
